<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <a href="index.php"> <img src="images/logo_final.jpg" class="navbar-brand logo"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="new_user.php">Sign Up<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
    ...
    <!-- <div class="search-box">
            ...
            <span class="input-group-text logo"><i class="fa fa-search"></i></span>
        </div>-->
        <div class="justfy-content-end">
                <form class="form-inline my-2 my-lg-0 search-box">
                    ...
                    <button class="btn btn-outline-success rounded-right my-2 my-sm-0" id="searchBtn" type="submit"><i class="fa fa-search"></i></button>
                </form>
        </div>
